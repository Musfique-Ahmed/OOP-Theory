...
class Item:
    ...
    def mix(self, other):
        ...
        if self.value > other.value:
            ...
            return Item(other.mix(self))
        else:
            other.value = other.value- self.value
...
print("\n=== End of Item Class Code Output Demo ===\n")
i1 = Item(12)
i2 = Item(11)
i3 = i2
i3.value = 34
...
print("A:", Item.total_items)
print("B:", i1, i2, i3)

print("C:", i1.mix(i2).display().value)
print("D:", i1, i2, i3)
print("E:", Item.total_items)